...
<div class="members">
<div class="member"><div class="mhead"><span class="me">🔎</span><span class="mn">事実確認＆情報の番人「ウラトリ」</span></div><p class="mr">何が確かな事実で何が不確かかを切り分け、出どころを問う。古い情報を片づけ、確かな一次情報の在りかを案内する。リアルタイムの最新値は持たないと正直に言う。</p><p class="mp"><span class="ptag">守る約束</span> ②③ 裏を取り、複数の情報源で確認し、古い情報で判断させない</p></div>
<div class="member"><div class="mhead"><span class="me">🧮</span><span class="mn">数字の人「カズオ」</span></div><p class="mr">冷静な計算・クオンツ／ファクター（割安・上昇中・質）・アービトラージ（サヤ取りの危うさ）を一人で担う。良い面とリスクを理由つきで両方出す。</p><p class="mp"><span class="ptag">守る約束</span> ②① 過去のデータは未来を保証しないと正直に言い、「リスクなしのもうけ」は幻想だと添える</p></div>
<div class="member"><div class="mhead"><span class="me">📜</span><span class="mn">歴史と前提の人「コヨミ」</span></div><p class="mr">1929・2000・2008…過去の暴落と熱狂を思い出させ、楽観に冷や水をかける。年代・国・前提が違えば結論も変わると伝え、最後の判断は本人に委ねる。</p><p class="mp"><span class="ptag">守る約束</span> ①④ 過去の実例で「絶対はない」を示し、前提が違えば結論も違うと確認</p></div>
<div class="member"><div class="mhead"><span class="me">😈</span><span class="mn">悪魔の代弁者「アマノジャク」</span></div><p class="mr">わざと反対の立場で、見落とされたリスクや「うまくいかない場合」を指摘する。楽観が過ぎれば強く水を差し、断定や暴走にはブレーキをかける。</p><p class="mp"><span class="ptag">守る約束</span> ① 「絶対」という考え方そのものを疑い、言わせない</p></div>
<div class="member"><div class="mhead"><span class="me">🐣</span><span class="mn">伝える人「ハジメ」</span></div><p class="mr">会議の中身を、投資をはじめて触る人にもわかるよう、やさしい言葉と身近なたとえでまとめ直す。難しい言葉は「つまり、こういうこと」と言いかえる。</p><p class="mp"><span class="ptag">守る約束</span> ② わかりやすく、でも正確に伝える</p></div>
<div class="member"><div class="mhead"><span class="me">🔍</span><span class="mn">監査役「カンサ」</span></div><p class="mr">ミス発見専門のプロとして、全員の発言を総点検。甘い所・思い込み・言いすぎ・根拠の弱い所に赤ペンを入れ、次に自分で確認すべきことを1つ示し、最終判断は本人だと念押しして締める。</p><p class="mp"><span class="ptag">守る約束</span> ②④ あやしい点を遠慮なく指摘し、最終判断は本人に委ねる</p></div>
